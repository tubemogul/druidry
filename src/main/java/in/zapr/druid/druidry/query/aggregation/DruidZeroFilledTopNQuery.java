...
public class DruidZeroFilledTopNQuery extends DruidAggregationQuery {
    ...
    @Builder
    private DruidZeroFilledTopNQuery(@NonNull String dataSource,
        ...
        this.queryType = QueryType.ZERO_FILLED_TOPN;

...
public class ZeroFilledTopNQueryTest {
    ...
    public void testSampleQuery() throws JsonProcessingException, JSONException {
        ...
        Context context = Context.builder()
                .zeroFilledDimValues(Arrays.asList("1", "2", "3"))
                .build();

        DruidZeroFilledTopNQuery query = DruidZeroFilledTopNQuery.builder()
    ...
    public void testRequiredFields() throws JsonProcessingException, JSONException {
        ...
        expectedQuery.put("queryType", "zeroFilledTopN");
    ...
    public void testAllFields() throws JSONException, JsonProcessingException {
        ...
        expectedContext.put("zeroFilledDimValues", new JSONArray(Arrays.asList("1", "2", "3")));
    ...
    public void testEquals() {
        ...
        DruidZeroFilledTopNQuery query1 = DruidZeroFilledTopNQuery.builder()
                .dataSource("sample_data")
                .intervals(Collections.singletonList(interval))
                .granularity(granularity)
                .filter(filter)
        ...
        DruidZeroFilledTopNQuery query2 = DruidZeroFilledTopNQuery.builder()
                .dataSource("sample_data")
                .intervals(Collections.singletonList(interval))
                .granularity(granularity)
                .filter(filter)
